...
export const getRoomReviews = (state: State): Review[] | null => state[NameSpace.Room].roomReviews;
...
export const getReviewAddProcessStatus = (state: State): boolean => state[NameSpace.Room].isReviewAddProcess;
